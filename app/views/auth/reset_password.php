    ...
    <head>
        ...
        <!-- favicon -->        <link rel="stylesheet" href="<?= BASE_URL ;?>/public/assets/css/notifications.css">
        ...
        <div class="col-md-5 mx-auto">
            <div class="login-form">
                <div class="login-header text-center">
                    ...
                    <p>Set a new password for your Mocart account</p>
                </div>
                ...
                <form action="<?= site_url('reset-password'); ?>" method="POST">
                    ...
                    <div class="d-flex align-items-center">
                        <button type="submit" class="theme-btn w-100">
                            <i class="far fa-check-circle"></i> Confirm Password
                        </button>
                    </div>
                </form>
            </div>
