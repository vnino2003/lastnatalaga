...
<head>
    ...
    <meta name="description" content="Admin account registration page for Mocart eCommerce platform.">
    <meta name="keywords" content="admin, register, account, ecommerce, Mocart">

    <title>Mocart - Admin Account Registration</title>
        ...
        <div class="site-breadcrumb">
            ...
            <div class="container">
                <div class="site-breadcrumb-wrap">
                    <h4 class="breadcrumb-title">Admin Registration</h4>
                ...
                <div class="col-md-5 mx-auto">
                    <div class="login-form">
                        <div class="login-header">
                            ...
                            <p>Create your new **Admin** account</p>
                        </div>
                        <form action="<?= site_url('setup-admin');?>" method="POST">
                            <div class="form-group">
                            ...
                            <div class="form-check form-group">
                                ...
                                <label class="form-check-label" for="agree">
                                    I confirm I am an authorized user and agree with the <a href="#">Admin Terms.</a>
                                </label>
                            </div>
                            <div class="d-flex align-items-center">
                                <button type="submit" class="theme-btn"><i class="far fa-paper-plane"></i> Create Admin Account</button>
                            </div>
                        </form>
                        <div class="login-footer">
                            <p>Return to admin login? <a href="admin-login.html">Login Here.</a></p>
                            </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="footer-widget-box about-us">
                            ...
                            <ul class="footer-contact">
                                ...
                                <li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#9ff6f1f9f0dffae7fef2eff3fab1fcf0f2"><i
                                                class="far fa-envelope"></i><span class="__cf_email__" data-cfemail="e78e898188a7829f868a978b82c984888a">[email&#160;protected]</span></a></li>
