...
<!-- Mirrored from live.themewild.com/mocart/register.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 19 Oct 2025 06:20:39 GMT -->
<head>
    <!-- meta tags -->
    <meta charset="UTF-8">
            ...
            <div class="container">
                <div class="col-md-5 mx-auto">
                    <div class="login-form">
                        ...
                        <form action="<?= site_url('registerr');?>" method="POST">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="confirm_password" class="form-control" placeholder="Your Password">
                            </div>
...
<a href="<?= site_url('register/googleRedirect'); ?>" class="gl-auth">
